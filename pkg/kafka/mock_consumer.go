...
func (m *MockConsumer) Consume(ctx context.Context, handler func([]byte)) error {
	m.ctrl.T.Helper()
...
func (mr *MockConsumerMockRecorder) Consume(ctx, handler interface{}) *gomock.Call {
